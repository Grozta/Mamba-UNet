...
parser.add_argument('--max_iteration', type=int, default=70000, help='maximum iteration to train')
parser.add_argument('--total_samples', type=int, default=30, help='total samples of the dataset')
parser.add_argument('--max_train_samples', type=int, default=18, help='maximum samples to train')
parser.add_argument('--max_test_samples', type=int, default=12, help='maximum samples to test')
...
if __name__ == "__main__":
    ...
    total_list = ["{}".format(item.strip().split('.')[0][-4:]) for item in total_list]
