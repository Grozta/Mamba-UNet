...
from networks.mamba_2D_mask import MambaUnetMask as VIM_seg
...
parser.add_argument('--pretrain_path', type=str, default='../pretrained_ckpt/Manba_2D_mask_pretrain.pth', help='path of pretrain')
parser.add_argument('--exp', type=str, default='train_Semi_Mamba_2D_mask', help='exp_name')
parser.add_argument('--model', type=str, default='Manba_2D', help='model_name')
